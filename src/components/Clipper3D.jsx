...
function BarberPole() {
  ...
  return (
    <group>
      ...
      <mesh position={[0, -1.36, 0]}>
        <cylinderGeometry args={[0.48, 0.50, 0.14, 64]} />
        <meshPhysicalMaterial color="#9aa0ab" roughness={0.15} metalness={0.85} envMapIntensity={2.5} />
      </mesh>
...
export default function Clipper3D() {
  ...
  useFrame((state) => {
    ...
    // Lerp scale : 1.0 au top → 2.2 en bas du hero
    const targetScale = 1 + scrollRef.current * 1.2
